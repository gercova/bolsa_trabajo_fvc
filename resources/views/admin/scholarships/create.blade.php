                    ...
                    <form action="{{ route('admin.scholarships.store') }}" method="POST" class="p-6 sm:p-8 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="vacancies" id="vacancies" value="{{ old('vacancies', 0) }}" min="0"
                                    placeholder="Ej. 10"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" step="0.01" min="0" max="100" name="discount_percentage" id="discount_percentage" 
                                        value="{{ old('discount_percentage', 0) }}" placeholder="Ej. 100.00 o 50.00"
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="discount_details" id="discount_details" value="{{ old('discount_details') }}" 
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="requirements" id="requirements" rows="4" 
                                    ...
                                    class="w-full text-sm p-4 border @error('requirements') border-rose-500 @else border-gray-300 @enderror rounded-xl focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all leading-relaxed">{{ old('requirements') }}</textarea>
