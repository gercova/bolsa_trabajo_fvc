...
<aside class="bg-slate-900 shadow-2xl transition-all duration-300 ease-in-out flex-shrink-0 fixed lg:relative inset-y-0 left-0 z-[45] lg:z-[40] top-[64px] lg:top-0" :class="sidebarOpen ? 'w-72 translate-x-0' : 'w-0 -translate-x-full lg:translate-x-0 lg:w-20'">
    <div class="flex flex-col h-full lg:h-[calc(100vh-64px)] lg:sticky lg:top-[64px] overflow-hidden">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto custom-scrollbar">
            <!-- Dashboard -->
            <a href="{{ route('admin.dashboard.index') }}" class="flex items-center px-4 py-3.5 rounded-xl transition-all duration-200 group relative overflow-hidden {{ request()->routeIs('dashboard') ? 'bg-gradient-to-r from-purple-600/20 to-indigo-600/20 text-white shadow-lg shadow-purple-900/20' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-100' }}">
            ...
            <a href="{{ route('admin.programs.index') }}" class="flex items-center px-4 py-3.5 rounded-xl transition-all duration-200 group relative overflow-hidden {{ request()->routeIs('admin.programs.*') ? 'bg-gradient-to-r from-purple-600/20 to-indigo-600/20 text-white shadow-lg shadow-purple-900/20' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-100' }}">
                <div class="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-purple-500 to-indigo-600 rounded-r-md transition-all duration-200 {{ request()->routeIs('admin.programs*') ? 'scale-y-100' : 'scale-y-0 group-hover:scale-y-75' }}"></div>
                <i class="bi bi-book text-xl transition-transform duration-200 group-hover:scale-110 {{ request()->routeIs('admin.programas*') ? 'text-purple-400' : 'text-slate-400 group-hover:text-purple-400' }}"></i>
            ...
            <!-- Gestionar puestos -->
            <a href="{{ route('admin.works.index') }}" class="flex items-center px-4 py-3.5 rounded-xl transition-all duration-200 group relative overflow-hidden {{ request()->routeIs('admin.works.*') ? 'bg-gradient-to-r from-purple-600/20 to-indigo-600/20 text-white shadow-lg shadow-purple-900/20' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-100' }}">
                <div class="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-purple-500 to-indigo-600 rounded-r-md transition-all duration-200 {{ request()->routeIs('admin.works*') ? 'scale-y-100' : 'scale-y-0 group-hover:scale-y-75' }}"></div>
                <i class="bi bi-briefcase text-xl transition-transform duration-200 group-hover:scale-110 {{ request()->routeIs('admin.works*') ? 'text-purple-400' : 'text-slate-400 group-hover:text-purple-400' }}"></i>
            ...
            <!-- Gestionar usuarios -->
            <a href="{{ route('admin.users.index') }}" class="flex items-center px-4 py-3.5 rounded-xl transition-all duration-200 group relative overflow-hidden {{ request()->routeIs('admin.users*') ? 'bg-gradient-to-r from-purple-600/20 to-indigo-600/20 text-white shadow-lg shadow-purple-900/20' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-100' }}">
                <div class="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-purple-500 to-indigo-600 rounded-r-md transition-all duration-200 {{ request()->routeIs('admin.users*') ? 'scale-y-100' : 'scale-y-0 group-hover:scale-y-75' }}"></div>
                <i class="bi bi-people text-xl transition-transform duration-200 group-hover:scale-110 {{ request()->routeIs('admin.users*') ? 'text-purple-400' : 'text-slate-400 group-hover:text-purple-400' }}"></i>
            ...
            <a href="{{ route('admin.partners.index') }}" class="flex items-center px-4 py-3.5 rounded-xl transition-all duration-200 group relative overflow-hidden {{ request()->routeIs('admin.partners.*') ? 'bg-gradient-to-r from-purple-600 to-indigo-600 text-white shadow-lg shadow-purple-900/50' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-100' }}">
                <div class="absolute left-0 top-0 bottom-0 w-1 bg-white rounded-r-md transition-all duration-200 {{ request()->routeIs('admin.partners.*') ? 'scale-y-100' : 'scale-y-0 group-hover:scale-y-75' }}"></div>
