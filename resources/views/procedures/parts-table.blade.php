    ...
    <section class="relative bg-gradient-to-br from-slate-950 via-slate-900 to-amber-950 text-white py-20 overflow-hidden">
        ...
        <div class="container mx-auto px-6 relative z-10 text-center max-w-4xl">
            ...
            <p class="text-base md:text-lg text-slate-300 leading-relaxed max-w-2xl mx-auto">
                Envía tus solicitudes y documentos oficiales de manera digital a las diferentes oficinas administrativas del instituto.
            </p>
        </div>
    </section>
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white rounded-3xl p-6 md:p-8 border border-slate-100 shadow-sm">
                        <div class="flex items-center justify-between mb-8 pb-4 border-b border-slate-100">
                            ...
                            <span class="text-xs font-bold bg-slate-50 text-slate-500 px-3 py-1 rounded-full border border-slate-100">
                                Trámite Virtual
                            </span>
                        </div>
                                    ...
                                    <template x-for="office in offices" :key="office.id">
                                        <div @click="selectedOffice = office" 
                                            ...
                                            <div class="w-10 h-10 rounded-xl flex items-center justify-center border shrink-0"
                                                 :class="selectedOffice.id === office.id ? 'bg-amber-50 border-amber-200 text-amber-600' : 'bg-slate-50 border-slate-100 text-slate-500'">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="grid grid-cols-3 gap-3">
                                        ...
                                        <div class="col-span-2">
                                            <label class="block text-xs font-bold text-slate-700 mb-1.5">Nro. de Documento</label>
                                            <input type="text" x-model="formData.docNum" required 
                                    ...
                                    {{-- Phone --}}
                                    <div>
                                        <label class="block text-xs font-bold text-slate-700 mb-1.5">Número Telefónico / Celular</label>
                            ...
                            <div class="pt-4 border-t border-slate-100">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                                    ...
                                    <div class="md:col-span-2">
                                        <label class="block text-xs font-bold text-slate-700 mb-1.5">Asunto / Resumen</label>
                                ...
                                {{-- Description --}}
                                <div class="mb-6">
                                    <label class="block text-xs font-bold text-slate-700 mb-1.5">Descripción de la Solicitud / Mensaje</label>
                                    <textarea x-model="formData.message" rows="4" required
                                ...
                                {{-- Document Attachment --}}
                                <div>
                                    <label class="block text-xs font-bold text-slate-700 mb-1.5">Adjuntar Documentos (FUT o Solicitud en PDF)</label>
                                    <div class="file-dropzone border-2 border-dashed border-slate-200 rounded-2xl p-6 text-center relative cursor-pointer">
                                        ...
                                        <div class="flex flex-col items-center justify-center gap-2">
                                            ...
                                            <div class="text-xs">
                                                <span class="font-bold text-amber-600 hover:text-amber-700">Haz clic para cargar</span> o arrastra tu archivo aquí
                                            </div>
                                        ...
                                        <div class="mt-3 p-3 bg-slate-50 border border-slate-100 rounded-xl flex items-center justify-between">
                                            <div class="flex items-center gap-2.5">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-[10px] text-slate-400" x-text="(uploadedFile.size / 1024 / 1024).toFixed(2) + ' MB'"></p>
                                                </div>
                                            </div>
                                            <button type="button" @click="uploadedFile = null" class="text-slate-400 hover:text-rose-500 p-1">
                ...
                <div class="space-y-8">
                    ...
                    <div class="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm">
                        ...
                        <div class="space-y-4">
                            <div class="p-4 bg-slate-50 rounded-2xl border border-slate-100 flex items-center gap-3">
                                <div class="w-10 h-10 rounded-xl bg-white border flex items-center justify-center text-amber-600 shrink-0">
                            ...
                            <div class="space-y-3.5 pt-2 text-xs">
                                ...
                                <div class="flex justify-between py-1 border-b border-slate-50">
                                    ...
                                    <a :href="'mailto:' + selectedOffice.email" class="font-bold text-amber-600 hover:underline" x-text="selectedOffice.email"></a>
                                </div>
                                <div class="flex justify-between py-1 border-b border-slate-50">
                    ...
                    <div class="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm relative overflow-hidden">
                        ...
                        <p class="text-xs text-slate-500 leading-relaxed mb-5">
                            Para realizar solicitudes formales de forma correcta, descarga el Formulario Único de Trámite (FUT), llénalo, fírmalo y adjúntalo a tu envío.
                        </p>
                        
                        <div class="space-y-2.5">
                            <a href="#" class="w-full p-3 bg-amber-50 hover:bg-amber-100/70 border border-amber-100 rounded-xl flex items-center justify-between text-xs font-bold text-amber-800 transition-colors">
                            ...
                            <a href="#" class="w-full p-3 bg-slate-50 hover:bg-slate-100 border border-slate-100 rounded-xl flex items-center justify-between text-xs font-bold text-slate-700 transition-colors">
                                <span class="flex items-center gap-2.5">
            ...
            <div class="bg-white rounded-3xl p-8 max-w-md w-full border border-slate-100 shadow-2xl text-center space-y-6"
                ...
                <div>
                    ...
                    <p class="text-slate-500 text-xs leading-relaxed">
                        Tu solicitud ha sido enviada a la <strong class="text-slate-700" x-text="selectedOffice.name"></strong>. Te hemos enviado un correo de confirmación de recepción del documento.
                    </p>
                </div>

                <div class="p-4 bg-slate-50 border border-slate-100 rounded-2xl text-left space-y-2 text-[11px] text-slate-600">
                    <div class="flex justify-between"><span class="font-bold">Trámite:</span> <span x-text="formData.type"></span></div>
                    <div class="flex justify-between"><span class="font-bold">Código de Registro:</span> <span class="font-mono text-amber-600 font-bold" x-text="generationCode"></span></div>
                    <div class="flex justify-between"><span class="font-bold">Destinatario:</span> <span x-text="selectedOffice.name"></span></div>
                </div>
                ...
                return {
                    ...
                    redirectToEmail() {
                        if (!this.formData.names || !this.formData.subject || !this.formData.message) {
                            alert("Por favor completa los campos principales (Nombres, Asunto y Mensaje) para generar el correo.");
                            return;
                        }
                    ...
                    redirectToWhatsApp() {
                        if (!this.formData.names || !this.formData.subject || !this.formData.message) {
                            alert("Por favor completa los campos principales (Nombres, Asunto y Mensaje) para generar el mensaje de WhatsApp.");
                            return;
                        }
