        ...
        <div class="space-y-4">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 card-hover">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                    <div class="flex items-start gap-4 mb-4 md:mb-0">
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap gap-2 mt-2">
                                <span class="bg-purple-100 text-purple-600 px-3 py-1 rounded-full text-sm">Tiempo
                                    completo</span>
                                <span class="bg-green-100 text-green-600 px-3 py-1 rounded-full text-sm">S/. 3000 -
                                    4000</span>
                    ...
                    <button
                        class="bg-purple-600 text-white px-6 py-2 rounded-lg hover:bg-purple-700 transition self-start md:self-center">
                        Ver detalles
                    </button>
                </div>
            </div>
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                    <div class="flex items-start gap-4 mb-4 md:mb-0">
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap gap-2 mt-2">
                                <span class="bg-purple-100 text-purple-600 px-3 py-1 rounded-full text-sm">Medio
                                    tiempo</span>
                                <span class="bg-green-100 text-green-600 px-3 py-1 rounded-full text-sm">S/. 1500 -
                                    2000</span>
