                    ...
                    <form @submit.prevent="submitForm" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                ...
                                <input type="text" id="title" x-model="form.title" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500" placeholder="Ej. Administrador de Redes, Técnico de Campo">
                            ...
                            <div>
                                ...
                                <input type="text" id="company" x-model="form.company" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500" placeholder="Ej. Grano Dorado S.A.C.">
                            ...
                            <div>
                                ...
                                <input type="text" id="location" x-model="form.location" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500" placeholder="Ej. Uchiza, San Martín">
                                <p x-show="errors.location" x-text="errors.location" class="mt-1 text-sm text-red-600" x-cloak></p>
                            </div>

                            <div>
                                <label for="url" class="block text-sm font-medium text-gray-700 mb-1">Enlace / URL de Postulación (Opcional)</label>
                                <input type="url" id="url" x-model="form.url" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500" placeholder="https://ejemplo.com/empleo">
                                <p x-show="errors.url" x-text="errors.url" class="mt-1 text-sm text-red-600" x-cloak></p>
                            </div>

                            <div>
                                <label for="source" class="block text-sm font-medium text-gray-700 mb-1">Fuente del empleo (Opcional)</label>
                                <input type="text" id="source" x-model="form.source" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500" placeholder="Ej. Bolsa Institucional, LinkedIn">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="description" x-model="form.description" rows="5" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500" placeholder="Detalla los requisitos, funciones y beneficios del puesto..."></textarea>
        ...
        Alpine.data('jobForm', () => ({
            ...
            async submitForm() {
                ...
                try {
                    ...
                    if (!response.ok) {
                        if (data.errors) {
                            // Mapea los errores devueltos por JobValidate directamente
                    ...
                    if (!this.errors || Object.keys(this.errors).length === 0) {
                        alert('Ocurrió un error inesperado al intentar guardar el registro.');
                    }
                } finally {
                    this.loading = false;
                }
