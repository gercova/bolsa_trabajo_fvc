@extends('layouts.app')
@section('title', 'Crear Competencia del Programa - Panel Administrativo')
@section('content')
    ...
    <div class="flex-1 flex flex-col min-w-0 bg-gray-50/50 relative">  
            ...
            <div class="px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <h1 class="text-xl sm:text-2xl font-extrabold text-gray-800 tracking-tight">
                        Registrar Competencia del Programa
                    </h1>
                </div>
                ...
                <div class="hidden sm:flex items-center text-sm font-medium text-gray-500">
                    ...
                    <span class="text-purple-600">Nueva Competencia</span>
                </div>
            </div>
        </header>
        ...
        <main class="flex-1 p-4 sm:p-6 lg:p-8 overflow-x-hidden">
            <div class="max-w-3xl mx-auto space-y-6">
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8 space-y-8" x-data="{ selectedIcon: '{{ old('icon', 'fa-graduation-cap') }}' }">
                    ...
                    <div class="flex items-center gap-4 p-4 rounded-xl bg-gradient-to-r from-purple-500/10 via-indigo-500/10 to-blue-500/10 border border-purple-100">
                        ...
                        <div>
                            <h3 class="text-sm font-bold text-gray-900">Nueva Competencia Formativa</h3>
                            <p class="text-xs text-gray-500 mt-0.5">Ingresa el título, ícono y descripción de la competencia del perfil profesional.</p>
                        </div>
                    </div>

                    <form method="POST" action="{{ route('admin.programs.competencies.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-1.5">
                                    ...
                                    <input type="text" id="icon" name="icon" x-model="selectedIcon" value="{{ old('icon', 'fa-graduation-cap') }}" placeholder="Ej: fa-graduation-cap, fa-heartbeat" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:bg-white focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all">
                                </div>
                                ...
                                <div class="space-y-1.5">
                                    ...
                                    <input type="number" id="order" name="order" value="{{ old('order', 0) }}" min="0" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:bg-white focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all">
                                </div>
                            </div>
