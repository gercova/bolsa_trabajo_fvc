@extends('layouts.app')
@section('title', 'Editar Registro Académico - Panel Administrativo')
        ...
        <div class="flex-1 flex flex-col min-w-0 bg-gray-50/50 relative">
                ...
                <div class="px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <h1 class="text-xl sm:text-2xl font-extrabold text-gray-800 tracking-tight flex items-center gap-2">
                            <i class="bi bi-pencil-square text-amber-500"></i> Editar Registro Académico
                        </h1>
                    </div>
                    ...
                    <div class="hidden sm:flex items-center text-sm font-medium text-gray-500">
                        ...
                        <i class="bi bi-chevron-right mx-2 text-xs text-gray-400"></i>
                        <span class="text-purple-600">Editar #{{ $studentRecord->id }}</span>
                    </div>
                </div>
            </header>
            ...
            <main class="flex-1 p-4 sm:p-6 lg:p-8 overflow-x-hidden">
                <div class="max-w-5xl mx-auto space-y-6">
                    ...
                    <form action="{{ route('admin.statistics.update', $studentRecord) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                                ...
                                <div>
                                    ...
                                    <select name="record_type" id="record_type" required
                                        ...
                                        <option value="ADMISION" {{ old('record_type', $studentRecord->record_type) === 'ADMISION' ? 'selected' : '' }}>Admisión (Postulante / Ingresante)</option>
                                        <option value="MATRICULA" {{ old('record_type', $studentRecord->record_type) === 'MATRICULA' ? 'selected' : '' }}>Matrícula (Estudiante Regular)</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="academic_period" id="academic_period" required
                                        value="{{ old('academic_period', $studentRecord->academic_period) }}" placeholder="ej. 2026-I, 2026-II"
                                ...
                                <div>
                                    ...
                                    <select name="study_program" id="study_program" required
                                        ...
                                        @foreach ($studyPrograms as $prog)
                                            <option value="{{ $prog->name }}" {{ old('study_program', $studentRecord->study_program) === $prog->name ? 'selected' : '' }}>{{ $prog->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="modality" id="modality"
                                        value="{{ old('modality', $studentRecord->modality) }}" placeholder="ej. ORDINARIO, EXTRAORDINARIO, CEPRE"
                                ...
                                <div>
                                    ...
                                    <select name="shift" id="shift"
                                        class="w-full text-sm border border-gray-300 rounded-xl py-2.5 px-3 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all">
                                        <option value="DIURNO" {{ old('shift', $studentRecord->shift) === 'DIURNO' ? 'selected' : '' }}>DIURNO</option>
                                        <option value="MAÑANA" {{ old('shift', $studentRecord->shift) === 'MAÑANA' ? 'selected' : '' }}>MAÑANA</option>
                                        <option value="NOCHE" {{ old('shift', $studentRecord->shift) === 'NOCHE' ? 'selected' : '' }}>NOCHE</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" step="0.01" min="0" max="100" name="score" id="score"
                                        value="{{ old('score', $studentRecord->score) }}" placeholder="ej. 16.50"
                                        class="w-full text-sm border border-gray-300 rounded-xl py-2.5 px-3 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="situation" id="situation"
                                        value="{{ old('situation', $studentRecord->situation) }}" placeholder="ej. INGRESÓ, NO INGRESÓ, MATRICULADO"
                                        class="w-full text-sm border border-gray-300 rounded-xl py-2.5 px-3 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all">
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="cycle" id="cycle"
                                        ...
                                        <option value="I" {{ old('cycle', $studentRecord->cycle) === 'I' ? 'selected' : '' }}>Ciclo I</option>
                                        <option value="II" {{ old('cycle', $studentRecord->cycle) === 'II' ? 'selected' : '' }}>Ciclo II</option>
                                        <option value="III" {{ old('cycle', $studentRecord->cycle) === 'III' ? 'selected' : '' }}>Ciclo III</option>
                                        <option value="IV" {{ old('cycle', $studentRecord->cycle) === 'IV' ? 'selected' : '' }}>Ciclo IV</option>
                                        <option value="V" {{ old('cycle', $studentRecord->cycle) === 'V' ? 'selected' : '' }}>Ciclo V</option>
                                        <option value="VI" {{ old('cycle', $studentRecord->cycle) === 'VI' ? 'selected' : '' }}>Ciclo VI</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="headquarters" id="headquarters"
                                        value="{{ old('headquarters', $studentRecord->headquarters ?? 'SEDE PRINCIPAL - UCHIZA') }}"
                                        class="w-full text-sm border border-gray-300 rounded-xl py-2.5 px-3 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                                ...
                                <div>
                                    ...
                                    <select name="document_type_id" id="document_type_id"
                                        ...
                                        @foreach ($documentTypes as $dt)
                                            <option value="{{ $dt->id }}" {{ old('document_type_id', $studentRecord->document_type_id) == $dt->id ? 'selected' : '' }}>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="document" id="document" maxlength="20"
                                        value="{{ old('document', $studentRecord->document) }}" placeholder="ej. 74859632"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="names" id="names" required maxlength="150"
                                        value="{{ old('names', $studentRecord->names) }}" placeholder="ej. Juan Carlos"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="last_name_father" id="last_name_father" maxlength="100"
                                        value="{{ old('last_name_father', $studentRecord->last_name_father) }}" placeholder="ej. Pérez"
                                        class="w-full text-sm border border-gray-300 rounded-xl py-2.5 px-3 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all font-semibold">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="last_name_mother" id="last_name_mother" maxlength="100"
                                        value="{{ old('last_name_mother', $studentRecord->last_name_mother) }}" placeholder="ej. Gómez"
                                        class="w-full text-sm border border-gray-300 rounded-xl py-2.5 px-3 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all font-semibold">
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="gender" id="gender"
                                        ...
                                        <option value="MASCULINO" {{ old('gender', $studentRecord->gender) === 'MASCULINO' ? 'selected' : '' }}>MASCULINO</option>
                                        <option value="FEMENINO" {{ old('gender', $studentRecord->gender) === 'FEMENINO' ? 'selected' : '' }}>FEMENINO</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="date" name="birthdate" id="birthdate"
                                        value="{{ old('birthdate', $studentRecord->birthdate ? $studentRecord->birthdate->format('Y-m-d') : '') }}"
                                        class="w-full text-sm border border-gray-300 rounded-xl py-2.5 px-3 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="mother_tongue" id="mother_tongue"
                                        value="{{ old('mother_tongue', $studentRecord->mother_tongue ?? 'Español') }}" placeholder="ej. Español, Quechua"
                                        class="w-full text-sm border border-gray-300 rounded-xl py-2.5 px-3 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="phone" id="phone" maxlength="20"
                                        value="{{ old('phone', $studentRecord->phone) }}" placeholder="ej. 987654321"
                                        class="w-full text-sm border border-gray-300 rounded-xl py-2.5 px-3 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all font-mono">
                                </div>
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <input type="email" name="email" id="email" maxlength="150"
                                        value="{{ old('email', $studentRecord->email) }}" placeholder="ej. estudiante@iestp.edu.pe"
                                        class="w-full text-sm border border-gray-300 rounded-xl py-2.5 px-3 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="pais_procedencia" id="pais_procedencia"
                                        value="{{ old('pais_procedencia', $studentRecord->pais_procedencia ?? 'PERÚ') }}"
                                        class="w-full text-sm border border-gray-300 rounded-xl py-2.5 px-3 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <input type="text" name="institution_name_ie" id="institution_name_ie" maxlength="200"
                                        value="{{ old('institution_name_ie', $studentRecord->institution_name_ie) }}" placeholder="ej. I.E. Francisco Vigo Caballero"
                                        class="w-full text-sm border border-gray-300 rounded-xl py-2.5 px-3 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" min="1950" max="2100" name="year_graduation" id="year_graduation"
                                        value="{{ old('year_graduation', $studentRecord->year_graduation) }}" placeholder="ej. 2025"
                                        class="w-full text-sm border border-gray-300 rounded-xl py-2.5 px-3 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all font-mono">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="modular_code_ie" id="modular_code_ie" maxlength="20"
                                        value="{{ old('modular_code_ie', $studentRecord->modular_code_ie) }}" placeholder="ej. 0485963"
                                        class="w-full text-sm border border-gray-300 rounded-xl py-2.5 px-3 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all font-mono">
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="management_type_ie" id="management_type_ie"
                                        class="w-full text-sm border border-gray-300 rounded-xl py-2.5 px-3 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all">
                                        <option value="PÚBLICA" {{ old('management_type_ie', $studentRecord->management_type_ie) === 'PÚBLICA' ? 'selected' : '' }}>PÚBLICA</option>
                                        <option value="PRIVADA" {{ old('management_type_ie', $studentRecord->management_type_ie) === 'PRIVADA' ? 'selected' : '' }}>PRIVADA</option>
                                        <option value="PARROQUIAL" {{ old('management_type_ie', $studentRecord->management_type_ie) === 'PARROQUIAL' ? 'selected' : '' }}>PARROQUIAL</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="region_ie" id="region_ie"
                                        value="{{ old('region_ie', $studentRecord->region_ie ?? 'SAN MARTÍN') }}"
                                        class="w-full text-sm border border-gray-300 rounded-xl py-2.5 px-3 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="province_ie" id="province_ie"
                                        value="{{ old('province_ie', $studentRecord->province_ie ?? 'TOCACHE') }}"
                                        class="w-full text-sm border border-gray-300 rounded-xl py-2.5 px-3 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="district_ie" id="district_ie"
                                        value="{{ old('district_ie', $studentRecord->district_ie ?? 'UCHIZA') }}"
                                        class="w-full text-sm border border-gray-300 rounded-xl py-2.5 px-3 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-end gap-3 pt-4">
                            ...
                            <button type="submit"
                                ...
                                <i class="bi bi-check-circle-fill"></i> Actualizar Registro
                            </button>
                        </div>
                    </form>
