    ...
    <div class="w-full max-w-xl glass-card rounded-3xl p-8 md:p-12 text-center relative z-10 fade-in-up">
        ...
        <div class="flex items-center justify-center gap-3 mb-8">
            ...
            <div class="text-left leading-none">
                ...
                <h2 class="text-sm font-display font-bold text-slate-200 mt-0.5">IESTP <span
                        class="text-gold-vivid">Francisco Vigo Caballero</span></h2>
            </div>
        </div>
        ...
        <!-- Error Message -->
        <h3 class="text-2xl font-display font-bold text-slate-100 mb-4">
            @yield('message')
        </h3>
