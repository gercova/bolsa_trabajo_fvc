@extends('layouts.app')
@section('title', 'Nueva Fase del Licenciamiento - Panel Administrativo')
...
<div id="dashboard-container" class="flex w-full bg-gray-50 font-sans text-gray-900 min-h-[calc(100vh-64px)]" x-data="dashboardApp()">
    ...
    <div class="flex-1 flex flex-col min-w-0 bg-gray-50/50 relative">
            ...
            <div class="px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <h1 class="text-xl sm:text-2xl font-extrabold text-gray-800 tracking-tight flex items-center gap-2">
                        <i class="bi bi-patch-plus text-purple-600"></i> Registrar Fase de Licenciamiento
                    </h1>
                </div>
                ...
                <div class="hidden sm:flex items-center text-sm font-medium text-gray-500">
                    ...
                    <span class="text-purple-600 font-semibold">Nueva Fase</span>
                </div>
            </div>
        </header>
        ...
        <main class="flex-1 p-4 sm:p-6 lg:p-8 overflow-x-hidden">
            <div class="max-w-4xl mx-auto space-y-6" x-data="phaseForm()">
                ...
                {{-- Form Card --}}
                <form action="{{ route('admin.licensing.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-12 gap-5">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <input type="number" id="phase_number" name="phase_number" min="1" max="20"
                                    value="{{ old('phase_number', $nextPhaseNumber) }}" required
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <input type="text" id="code" name="code" placeholder="Ej. CBC-01, REG-02"
                                    value="{{ old('code', "FASE-0{$nextPhaseNumber}") }}"
                            ...
                            <div class="sm:col-span-12">
                                ...
                                <textarea id="description" name="description" rows="4" placeholder="Detalla el alcance, los requerimientos evaluados por el MINEDU y el avance en el IESTP..."
                                    class="w-full px-4 py-3 text-sm border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all leading-relaxed">{{ old('description') }}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-12 gap-5">
                            ...
                            <div class="sm:col-span-6">
                                ...
                                <select id="status" name="status" required
                                    ...
                                    <option value="observed" {{ old('status') === 'observed' ? 'selected' : '' }}>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-12 gap-5">
                            ...
                            <div class="sm:col-span-6">
                                <label for="file_path" class="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-2">
                                    Documento / Expediente Adjunto (PDF)
                                </label>
                                ...
                                <p class="text-[11px] text-gray-400 mt-1">Formatos admitidos: PDF, DOC, DOCX, ZIP (Máx. 20MB)</p>
                            </div>
                    ...
                    <div class="flex items-center justify-end gap-3 pt-4">
                        ...
                        <button type="submit"
                            ...
                            Guardar Fase de Licenciamiento
                        </button>
                    </div>
                </form>
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('phaseForm', () => ({
            progress: {{ old('progress_percentage', 0) }},
            milestones: [],
            addMilestone() {
