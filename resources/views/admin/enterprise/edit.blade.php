                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div class="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                            ...
                            <div class="p-4 sm:p-6 space-y-4">
                             ...
                             <div class="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                            <div class="px-4 sm:px-6 py-4 bg-gradient-to-r from-orange-50 to-amber-50 border-b border-gray-100 flex items-center justify-between">
                                <h2 class="text-base sm:text-lg font-bold text-gray-800 flex items-center">
                                    <i class="bi bi-geo-alt-fill mr-2 text-orange-600"></i>
                                    Ubicación y Mapa de Google Maps
                                </h2>
                                <a href="https://www.google.com/maps/place/FRANCISCO+VIGO+CABALLERO/@-8.4505844,-76.465598,16z/data=!4m6!3m5!1s0x91af63dcf2a7d793:0x39afb5dd2aae7783!8m2!3d-8.4490562!4d-76.4660333!16s%2Fg%2F11hzzr2wh2"
                                   target="_blank" rel="noopener noreferrer"
                                   class="hidden sm:inline-flex items-center gap-1.5 text-xs font-semibold text-orange-700 bg-orange-100/80 hover:bg-orange-200 px-3 py-1.5 rounded-lg transition">
                            ...
                            <div class="p-4 sm:p-6 space-y-5">
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                                    <div>
                                        ...
                                        <input type="text" 
                                               ...
                                               class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition"
                                               placeholder="Ej: Av. Ricardo Palma N° 1401">
                                    </div>
                                ...
                                <div>
                                    <div class="flex items-center justify-between mb-2">
                                        <label class="block text-sm font-medium text-gray-700">
                                            <i class="bi bi-map-fill mr-1 text-orange-600"></i>Código Iframe de Google Maps
                                        </label>
                                        <span class="text-xs text-gray-500">Pega el código &lt;iframe&gt; o URL de inserción</span>
                                    </div>

                                    <textarea name="google_maps_iframe" 
                                              rows="4"
                                              x-model="mapsIframe"
                                              class="w-full font-mono text-xs px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition @error('google_maps_iframe') border-red-500 @enderror"
                                              placeholder="<iframe src='https://www.google.com/maps/embed?...' width='100%' height='450' style='border:0;' allowfullscreen='' loading='lazy'></iframe>">{{ old('google_maps_iframe', $enterprise->google_maps_iframe) }}</textarea>
                                    @error('google_maps_iframe')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror

                                    <div class="mt-2 bg-amber-50/70 border border-amber-200/80 rounded-xl p-3 text-xs text-amber-900 flex items-start gap-2.5">
                                        <i class="bi bi-info-circle-fill text-amber-600 text-sm shrink-0 mt-0.5"></i>
                                        <div class="space-y-1">
                                            <p class="font-bold">¿Cómo obtener el código iframe de Google Maps?</p>
                                            <p class="text-gray-600 leading-relaxed">
                                                1. Ingresa a <a href="https://www.google.com/maps/place/FRANCISCO+VIGO+CABALLERO/@-8.4505844,-76.465598,16z/data=!4m6!3m5!1s0x91af63dcf2a7d793:0x39afb5dd2aae7783!8m2!3d-8.4490562!4d-76.4660333!16s%2Fg%2F11hzzr2wh2" target="_blank" rel="noopener noreferrer" class="text-purple-600 font-bold underline">Google Maps</a>.<br>
                                                2. Haz clic en <strong>Compartir</strong> y luego en la pestaña <strong>Insertar un mapa</strong>.<br>
                                                3. Haz clic en <strong>Copiar HTML</strong> y pégalo en este campo.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">
                                        <i class="bi bi-eye mr-1"></i>Vista Previa del Mapa
                                    </label>
                                    <div class="w-full h-64 sm:h-80 bg-gray-100 rounded-xl border border-gray-200 overflow-hidden relative flex items-center justify-center">
                                        @if($enterprise->google_maps_iframe)
                                        ...
                                        @else
                                            <div class="text-center p-6 text-gray-400">
                                                <i class="bi bi-geo-alt text-3xl mb-1 block"></i>
                                                <span>Pega el código iframe para visualizar la vista previa en tiempo real</span>
                                            </div>
                                        @endif
                                    </div>
                                </div>
...
<script>
    document.addEventListener('alpine:init', () => {
        ...
        Alpine.data('enterpriseApp', () => ({
            ...
            complaintsBookName: '',
            complaintsBookSize: '',
            mapsIframe: @json(old('google_maps_iframe', $enterprise->google_maps_iframe)),
