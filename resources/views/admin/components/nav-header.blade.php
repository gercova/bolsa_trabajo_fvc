    ...
    <div class="nav-inner">
        ...
        <nav class="nav-links" aria-label="Navegación principal">
            ...
            <div class="nav-dropdown" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false"
                ...
                <div class="dropdown-panel" x-show="open" x-transition:enter="dropdown-enter"
        ...
        <div class="nav-right">
            @auth
                <div class="nav-dropdown" x-data="{ open: false }" @click.outside="open = false">
                    ...
                    <div class="dropdown-panel dropdown-panel--right" x-show="open" x-transition:enter="dropdown-enter"
                        x-transition:enter-start="dropdown-enter-start" x-transition:enter-end="dropdown-enter-end"
                        x-transition:leave="dropdown-leave" x-transition:leave-start="dropdown-enter-end"
                        x-transition:leave-end="dropdown-enter-start" style="display:none;">
                        <div class="dropdown-panel-inner">
        ...
        <button class="hamburger" @click="mobileMenuOpen = !mobileMenuOpen" :aria-expanded="mobileMenuOpen"
            aria-label="Abrir menú" aria-controls="mobile-menu">
...
═══════════════════════════════════════════════════════════ --}}
<div id="mobile-menu" role="dialog" aria-label="Menú móvil" aria-modal="true" x-show="mobileMenuOpen"
    ...
    class="fixed left-0 right-0 z-40 overflow-y-auto bg-white/98 backdrop-blur-md border-b border-sky-100 shadow-xl lg:hidden"
    :style="'top: ' + document.getElementById('site-header')?.offsetHeight + 'px; max-height: calc(100vh - ' + (document
        .getElementById('site-header')?.offsetHeight ?? 68) + 'px)'"
    style="display:none; top: var(--nav-h); max-height: calc(100vh - var(--nav-h))">

    <div class="mobile-nav-inner">

        {{-- Inicio --}}
        <a href="{{ route('inicio') }}" class="mobile-link {{ request()->routeIs('inicio') ? 'active' : '' }}">
            <i class="bi bi-house-door"></i> Inicio
        </a>

        {{-- Admisión y Matrícula --}}
        <div x-data="{ open: {{ request()->routeIs('cepre-fvc', 'examen-de-admision', 'matriculas', 'becas-y-creditos') ? 'true' : 'false' }} }" class="w-full">
            ...
            <div x-show="open" x-collapse style="display:none;" class="mobile-sub">
                <a href="{{ route('cepre-fvc') }}" class="mobile-sub-link {{ request()->routeIs('cepre-fvc') ? 'active' : '' }}">CEPRE FVC</a>
                <a href="{{ route('examen-de-admision') }}" class="mobile-sub-link {{ request()->routeIs('examen-de-admision') ? 'active' : '' }}">Examen de Admisión</a>
                <a href="{{ route('matriculas') }}" class="mobile-sub-link {{ request()->routeIs('matriculas') ? 'active' : '' }}">Matrículas</a>
                <a href="{{ route('becas-y-creditos') }}" class="mobile-sub-link {{ request()->routeIs('becas-y-creditos') ? 'active' : '' }}">Becas y Créditos</a>
            </div>
        </div>
        ...
        <div x-data="{ open: {{ request()->routeIs('documentos-de-gestion', 'estadisticas', 'inversion-y-gestion', 'licenciamiento', 'libro-de-reclamaciones') ? 'true' : 'false' }} }" class="w-full">
            ...
            <div x-show="open" x-collapse style="display:none;" class="mobile-sub">
                <a href="{{ route('documentos-de-gestion') }}" class="mobile-sub-link {{ request()->routeIs('documentos-de-gestion') ? 'active' : '' }}">Documentos de Gestión</a>
                <a href="{{ route('estadisticas') }}" class="mobile-sub-link {{ request()->routeIs('estadisticas') ? 'active' : '' }}">Estadísticas</a>
                <a href="{{ route('inversion-y-gestion') }}" class="mobile-sub-link {{ request()->routeIs('inversion-y-gestion') ? 'active' : '' }}">Inversión y Gestión</a>
                <a href="{{ route('licenciamiento') }}" class="mobile-sub-link {{ request()->routeIs('licenciamiento') ? 'active' : '' }}">Licenciamiento</a>
                <a href="{{ route('libro-de-reclamaciones') }}" class="mobile-sub-link {{ request()->routeIs('libro-de-reclamaciones') ? 'active' : '' }}">Libro de Reclamaciones</a>
            </div>
        </div>

        {{-- Trámites --}}
        <div x-data="{ open: {{ request()->routeIs('mesa-de-partes', 'tupa') ? 'true' : 'false' }} }" class="w-full">
            <button @click="open = !open" class="mobile-link mobile-link--accordion w-full"
                :class="open ? 'active' : ''" :aria-expanded="open">
                <div class="flex items-center gap-3">
            ...
            <div x-show="open" x-collapse style="display:none;" class="mobile-sub">
                <a href="{{ route('mesa-de-partes') }}" class="mobile-sub-link {{ request()->routeIs('mesa-de-partes') ? 'active' : '' }}">Mesa de Partes</a>
                <a href="{{ route('tupa') }}" class="mobile-sub-link {{ request()->routeIs('tupa') ? 'active' : '' }}">TUPA</a>
            </div>
        </div>

        {{-- Nosotros --}}
        <div x-data="{ open: {{ request()->routeIs('quienes-somos', 'historia', 'organigrama-institucional', 'plana-jerarquica', 'plana-de-docentes', 'plana-administrativa', 'consejo-de-estudiantes', 'locales') ? 'true' : 'false' }} }" class="w-full">
            <button @click="open = !open" class="mobile-link mobile-link--accordion w-full"
                :class="open ? 'active' : ''" :aria-expanded="open">
                <div class="flex items-center gap-3">
            ...
            <div x-show="open" x-collapse style="display:none;" class="mobile-sub">
                <a href="{{ route('quienes-somos') }}" class="mobile-sub-link {{ request()->routeIs('quienes-somos') ? 'active' : '' }}">¿Quiénes somos?</a>
                <a href="{{ route('historia') }}" class="mobile-sub-link {{ request()->routeIs('historia') ? 'active' : '' }}">Reseña Histórica</a>
                <a href="{{ route('organigrama-institucional') }}" class="mobile-sub-link {{ request()->routeIs('organigrama-institucional') ? 'active' : '' }}">Organigrama</a>
                <a href="{{ route('plana-jerarquica') }}" class="mobile-sub-link {{ request()->routeIs('plana-jerarquica') ? 'active' : '' }}">Plana Jerárquica</a>
                <a href="{{ route('plana-de-docentes') }}" class="mobile-sub-link {{ request()->routeIs('plana-de-docentes') ? 'active' : '' }}">Plana Docente</a>
                <a href="{{ route('plana-administrativa') }}" class="mobile-sub-link {{ request()->routeIs('plana-administrativa') ? 'active' : '' }}">Plana Administrativa</a>
                <a href="{{ route('consejo-de-estudiantes') }}" class="mobile-sub-link {{ request()->routeIs('consejo-de-estudiantes') ? 'active' : '' }}">Consejo de Estudiantes</a>
                <a href="{{ route('locales') }}" class="mobile-sub-link {{ request()->routeIs('locales') ? 'active' : '' }}">Locales</a>
            </div>
        </div>
