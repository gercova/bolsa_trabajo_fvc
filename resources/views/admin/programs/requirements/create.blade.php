@extends('layouts.app')
@section('title', 'Crear Requisito de Admisión - Panel Administrativo')
@section('content')
            ...
            <div class="px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <h1 class="text-xl sm:text-2xl font-extrabold text-gray-800 tracking-tight">
                        Registrar Requisito del Programa
                    </h1>
                </div>
                ...
                <div class="hidden sm:flex items-center text-sm font-medium text-gray-500">
                    ...
                    <span class="text-purple-600">Nuevo Requisito</span>
                </div>
            </div>
        </header>
            ...
            <div class="max-w-3xl mx-auto space-y-6">
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8 space-y-8">
                    ...
                    <div class="flex items-center gap-4 p-4 rounded-xl bg-gradient-to-r from-purple-500/10 via-indigo-500/10 to-blue-500/10 border border-purple-100">
                        ...
                        <div>
                            <h3 class="text-sm font-bold text-gray-900">Nuevo Requisito de Admisión / Ingreso</h3>
                            <p class="text-xs text-gray-500 mt-0.5">Ingresa los documentos o condiciones requeridas para matricularse en este programa.</p>
                        </div>
                    </div>

                    <form method="POST" action="{{ route('admin.programs.requirements.store') }}" class="space-y-6">
                        @csrf
