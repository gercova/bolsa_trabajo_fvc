<header id="site-header">
    <div class="nav-inner">
        ...
        <nav class="nav-links hidden md:flex items-center lg:gap-1 xl:gap-2">
            <a href="{{ route('inicio') }}" class="nav-link whitespace-nowrap {{ request()->routeIs('inicio') ? 'active' : '' }}">
                Inicio
            </a>

            <div class="dropdown-wrap h-full flex items-center">
                <button type="button" class="nav-link bg-transparent border-none cursor-pointer whitespace-nowrap flex items-center gap-1.5">
            ...
            <a href="{{ route('programas-de-estudio') }}" class="nav-link whitespace-nowrap {{ request()->routeIs('ofertas') ? 'active' : '' }}">
            ...
            <div class="dropdown-wrap h-full flex items-center">
                <button type="button" class="nav-link bg-transparent border-none cursor-pointer whitespace-nowrap flex items-center gap-1.5 {{ request()->routeIs('nosotros') ? 'active' : '' }}">
            ...
            <div class="dropdown-wrap h-full flex items-center">
                <button type="button" class="nav-link bg-transparent border-none cursor-pointer whitespace-nowrap flex items-center gap-1.5 {{ request()->routeIs('servicios') ? 'active' : '' }}">
                    Servicios <i class="bi bi-chevron-down text-[10px]"></i>
                </button>
                <div class="dropdown-menu !top-[80%] !left-0 !right-auto w-[240px]">
                    <a href="{{ route('quienes-somos') }}" class="dropdown-item">Biblioteca Virtual</a>
            ...
            @auth
                <div class="dropdown-wrap">
                    <button class="user-trigger flex items-center" type="button" aria-haspopup="true">
                        ...
                        <span class="user-name whitespace-nowrap truncate max-w-[180px]">{{ explode(" ", Auth::user()->names)[0]; }}</span>
                        <i class="bi bi-chevron-down user-chevron ml-1"></i>
                    </button>
                    <div class="dropdown-menu" role="menu">
                        <a href="{{ route('profile.edit', auth()->user()) }}" class="dropdown-item" role="menuitem">
...
<div id="mobile-menu" aria-hidden="true" class="overflow-y-auto max-h-[calc(100vh-var(--nav-h))] md:hidden">
    <div class="mobile-nav-inner flex flex-col gap-1">
        ...
        <div x-data="{ open: false }" class="w-full">
            <button @click="open = !open" class="mobile-link w-full bg-transparent border-none flex justify-between items-center cursor-pointer">
                <div class="flex items-center gap-[12px]">
                    <i class="bi bi-journal-bookmark w-[22px] text-center text-[18px]"></i> Admisión y Matrícula
                </div>
                <i class="bi bi-chevron-down transition-transform duration-200 text-[14px]" :class="open ? 'rotate-180' : ''"></i>
            </button>
            <div x-show="open" style="display: none;" class="pl-[46px] pr-4 py-2 flex flex-col gap-3">
                <a href="#" class="text-[14px] font-medium text-[var(--ink-muted)] hover:text-[var(--ink)] transition-colors">CEPRE FVC</a>
                <a href="#" class="text-[14px] font-medium text-[var(--ink-muted)] hover:text-[var(--ink)] transition-colors">Examen de Admisión</a>
                <a href="#" class="text-[14px] font-medium text-[var(--ink-muted)] hover:text-[var(--ink)] transition-colors">Matrículas</a>
                <a href="#" class="text-[14px] font-medium text-[var(--ink-muted)] hover:text-[var(--ink)] transition-colors">Becas y Créditos</a>
            </div>
        </div>
        ...
        <div x-data="{ open: false }" class="w-full">
            ...
            <div x-show="open" style="display: none;" class="pl-[46px] pr-4 py-2 flex flex-col gap-3">
                <a href="#" class="text-[14px] font-medium text-[var(--ink-muted)] hover:text-[var(--ink)] transition-colors">Documentos de gestión</a>
                <a href="#" class="text-[14px] font-medium text-[var(--ink-muted)] hover:text-[var(--ink)] transition-colors">Estadísticas</a>
                <a href="#" class="text-[14px] font-medium text-[var(--ink-muted)] hover:text-[var(--ink)] transition-colors">Inversión y gestión</a>
                <a href="#" class="text-[14px] font-medium text-[var(--ink-muted)] hover:text-[var(--ink)] transition-colors">Licenciamiento</a>
                <a href="#" class="text-[14px] font-medium text-[var(--ink-muted)] hover:text-[var(--ink)] transition-colors">Libro de reclamaciones</a>
            </div>
        </div>
        ...
        <div x-data="{ open: false }" class="w-full">
            ...
            <div x-show="open" style="display: none;" class="pl-[46px] pr-4 py-2 flex flex-col gap-3">
                <a href="#" class="text-[14px] font-medium text-[var(--ink-muted)] hover:text-[var(--ink)] transition-colors">Mesa de Partes</a>
                <a href="#" class="text-[14px] font-medium text-[var(--ink-muted)] hover:text-[var(--ink)] transition-colors">TUPA</a>
            </div>
        </div>
        ...
        <div x-data="{ open: false }" class="w-full">
            ...
            <div x-show="open" style="display: none;" class="pl-[46px] pr-4 py-2 flex flex-col gap-3">
                <a href="{{ route('quienes-somos') }}" class="text-[14px] font-medium text-[var(--ink-muted)] hover:text-[var(--ink)] transition-colors">Reseña Histórica</a>
                <a href="#" class="text-[14px] font-medium text-[var(--ink-muted)] hover:text-[var(--ink)] transition-colors">Organigrama Institucional</a>
                <a href="#" class="text-[14px] font-medium text-[var(--ink-muted)] hover:text-[var(--ink)] transition-colors">Plana Jerárquica</a>
                <a href="#" class="text-[14px] font-medium text-[var(--ink-muted)] hover:text-[var(--ink)] transition-colors">Plana Docente</a>
                <a href="#" class="text-[14px] font-medium text-[var(--ink-muted)] hover:text-[var(--ink)] transition-colors">Plana Administrativa</a>
                <a href="#" class="text-[14px] font-medium text-[var(--ink-muted)] hover:text-[var(--ink)] transition-colors">Consejo de Estudiantes</a>
                <a href="#" class="text-[14px] font-medium text-[var(--ink-muted)] hover:text-[var(--ink)] transition-colors">Locales</a>
            </div>
        </div>
        ...
        @auth
            ...
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit" class="mobile-link w-full bg-transparent border-none text-left text-[#DC2626] cursor-pointer">
