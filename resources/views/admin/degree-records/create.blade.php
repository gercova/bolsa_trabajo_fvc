@extends('layouts.app')
@section('title', 'Nuevo Registro de Grado/Título')
        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <header class="bg-white border-b border-gray-200 sticky top-[64px] lg:top-0 z-[30] shadow-sm">
                <div class="px-4 sm:px-6 py-3 sm:py-4 flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-lg font-extrabold text-gray-800">Nuevo Registro de Grado / Título</h1>
                        <p class="text-xs text-gray-500">Transparencia → Títulos</p>
                    </div>
                </div>
            </header>
            ...
            <main class="flex-1 p-4 sm:p-6 lg:p-8">
                <div class="max-w-4xl mx-auto">
                    <form action="{{ route('admin.degree-records.store') }}" method="POST"
                        class="space-y-6">
                        @csrf
                        @include('admin.degree-records._form', ['record' => null])
                        <div class="flex items-center gap-3 justify-end">
                            ...
                            <button type="submit"
                                class="px-6 py-2.5 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-xl text-sm font-extrabold shadow-md transition hover:shadow-lg">
                                <i class="bi bi-save mr-1"></i> Guardar Registro
                            </button>
                        </div>
                    </form>
                </div>
