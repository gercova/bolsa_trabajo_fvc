...
class EnterpriseValidate extends FormRequest
{
    ...
    public function rules(): array {
        return [
            ...
            'legal_representative_dni'  => 'nullable|string|max:11',
            ...
            'complaints_book_path'      => 'nullable|file|mimes:pdf|max:5120',
    ...
    public function messages() {
        return [
            ...
            'complaints_book_path.file'  => 'El libro de reclamaciones debe ser un archivo válido.',
            'complaints_book_path.mimes' => 'El libro de reclamaciones debe ser un archivo de tipo: pdf.',
            'complaints_book_path.max'   => 'El libro de reclamaciones no debe superar los 5 MB.',
            ...
            'google_maps_iframe.string' => 'El código de Google Maps debe ser un texto válido.',
        ];
    }
