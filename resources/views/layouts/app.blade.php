...
<head>
    ...
    {{-- ═══ TAILWIND CDN ══════════════════════════════════════════ --}}
    <script src="{{ asset('js/cdn.tailwind-3.4.17.js') }}"></script>
    <script>
        tailwind.config = {
            theme: {
                extend: {
    ...
    {{-- ═══ ALPINE.JS ══════════════════════════════════════════════ --}}
    <script defer src="{{ asset('js/cdn.alpine.min.js') }}"></script>
</head>

<body x-data="{ mobileMenuOpen: false }" :class="mobileMenuOpen ? 'overflow-hidden' : ''"
    ...
    {{-- ═══ FOOTER ════════════════════════════════════════════════ --}}
    @unless (request()->routeIs('admin.*') || request()->is('admin*') || request()->routeIs('dashboard'))
                ...
                <div>
                    <div class="footer-brand-badge">
                        ...
                        <div class="footer-title">
                            IESTP<br>Francisco Vigo Caballero
                        </div>
                    </div>
                    <p class="footer-desc">
                    ...
                    <address class="not-italic">
                        @if ($enterprise->address || $enterprise->city)
                            <div class="footer-contact-item">
                                <div class="footer-contact-icon"><i class="bi bi-geo-alt-fill" aria-hidden="true"></i>
                                </div>
                        ...
                        @if ($enterprise->phone_number_1)
                            <div class="footer-contact-item">
                                <div class="footer-contact-icon"><i class="bi bi-telephone-fill" aria-hidden="true"></i>
                                </div>
                        ...
                        @if ($enterprise->phone_number_2)
                            <div class="footer-contact-item">
                                ...
                                <a href="tel:{{ $enterprise->phone_number_2 }}"
                                    class="hover:text-white transition-colors">
                        ...
                        @if ($enterprise->email)
                            <div class="footer-contact-item">
                                <div class="footer-contact-icon"><i class="bi bi-envelope-fill" aria-hidden="true"></i>
                                </div>
                    ...
                    <div class="social-grid" role="list" aria-label="Redes sociales">
                        @if ($enterprise->facebook_link)
                            <a href="{{ $enterprise->facebook_link }}" class="social-btn fb" target="_blank"
                                rel="noopener noreferrer" aria-label="Visítanos en Facebook" role="listitem">
                                <i class="bi bi-facebook" aria-hidden="true"></i>
                            </a>
                        @endif
                        @if ($enterprise->twitter_link)
                            <a href="{{ $enterprise->twitter_link }}" class="social-btn tw" target="_blank"
                                rel="noopener noreferrer" aria-label="Síguenos en Twitter/X" role="listitem">
                                <i class="bi bi-twitter-x" aria-hidden="true"></i>
                            </a>
                        @endif
                        @if ($enterprise->linkedin_link)
                            <a href="{{ $enterprise->linkedin_link }}" class="social-btn li" target="_blank"
                                rel="noopener noreferrer" aria-label="Conéctanos en LinkedIn" role="listitem">
                                <i class="bi bi-linkedin" aria-hidden="true"></i>
                            </a>
                        @endif
                        @if ($enterprise->instagram_link)
                            <a href="{{ $enterprise->instagram_link }}" class="social-btn ig" target="_blank"
                                rel="noopener noreferrer" aria-label="Síguenos en Instagram" role="listitem">
                                <i class="bi bi-instagram" aria-hidden="true"></i>
                            </a>
                        @endif
                        @if ($enterprise->whatsapp_link)
                            <a href="{{ $enterprise->whatsapp_link }}" class="social-btn wa" target="_blank"
                                rel="noopener noreferrer" aria-label="Escríbenos por WhatsApp" role="listitem">
