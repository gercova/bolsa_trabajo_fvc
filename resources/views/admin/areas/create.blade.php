@extends('layouts.app')
@section('title', 'Nueva Área Institucional - Panel Administrativo')
                ...
                <div class="px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <h1 class="text-xl sm:text-2xl font-extrabold text-gray-800 tracking-tight flex items-center gap-2">
                            <i class="bi bi-plus-circle text-purple-600"></i> Registrar Área Institucional
                        </h1>
                    </div>
                    ...
                    <div class="hidden sm:flex items-center text-sm font-medium text-gray-500">
                        ...
                        <span class="text-purple-600 font-semibold">Nueva</span>
                    </div>
                </div>
            </header>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                        <div class="p-6 sm:p-8 border-b border-gray-100 bg-gray-50/40">
                            <h2 class="text-lg font-bold text-gray-800 flex items-center gap-2">
                                <i class="bi bi-info-circle text-purple-600"></i> Información del Área
                            </h2>
                            <p class="text-xs text-gray-500 mt-1">Complete los campos requeridos para registrar una nueva
                                área o dependencia institucional.</p>
                        </div>

                        <form action="{{ route('admin.areas.store') }}" method="POST" class="p-6 sm:p-8 space-y-6">
                            @csrf
