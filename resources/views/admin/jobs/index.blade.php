        ...
        <div class="flex-1 flex flex-col min-w-0 bg-gray-50/50 relative">
                ...
                <div class="px-6 py-4 flex items-center justify-between">
                    <div class="flex items-center">
                        <button @click="toggleSidebar()"
                            class="mr-4 text-gray-500 hover:text-purple-600 hover:bg-purple-50 p-2 rounded-lg transition-colors lg:hidden">
                            <i class="bi bi-list text-2xl"></i>
                        </button>
                        <h1 class="text-2xl font-extrabold text-gray-800 tracking-tight">Bolsa de Trabajo</h1>
                    </div>
                    <a href="{{ route('admin.works.create') }}"
                        class="px-4 py-2.5 bg-purple-600 text-white font-semibold rounded-lg hover:bg-purple-700 transition flex items-center gap-2 shadow-sm text-sm">
            ...
            <main class="flex-1 p-6 lg:p-8" x-data="jobsList({{ json_encode($jobs) }})">
                <div class="max-w-7xl mx-auto space-y-6">
                    ...
                    <div
                        class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex flex-col sm:flex-row gap-4 justify-between items-center">
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                        <div class="overflow-x-auto">
                            <table class="w-full text-left border-collapse">
                                <thead>
                                    <tr
                                        class="bg-gray-50 border-b border-gray-200 text-xs font-bold uppercase tracking-wider text-gray-500">
                                        ...
                                        <tr class="hover:bg-gray-50/70 transition-colors">
                                            ...
                                            <td class="px-6 py-4">
                                                <span
                                                    ...
                                                    x-text="job.source || 'No especificada'"></span>
                                            </td>
                                            <td class="px-6 py-4">
                                            ...
                                            <td class="px-6 py-4 text-right space-x-2">
                                                <a :href="`{{ route('admin.works.edit', job.id) }}`"
            ...
            Alpine.data('jobsList', (initialJobs) => ({
                ...
                get filteredJobs() {
                    ...
                    return this.jobs.filter(job => {
                        return job.title.toLowerCase().includes(this.search
                        .toLowerCase()) ||
                ...
                async deleteJob(id) {
                    if (!confirm(
                            '¿Estás completamente seguro de eliminar esta oferta laboral? Esta acción no se puede deshacer.'
                            )) return;
