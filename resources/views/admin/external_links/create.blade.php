@extends('layouts.app')
@section('title', 'Nuevo Enlace Institucional - Panel Administrativo')
            ...
            <div class="px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <h1 class="text-xl sm:text-2xl font-extrabold text-gray-800 tracking-tight flex items-center gap-2">
                        <i class="bi bi-box-arrow-up-right text-purple-600"></i> Nuevo Enlace Institucional
                    </h1>
                </div>
                ...
                <div class="hidden sm:flex items-center text-sm font-medium text-gray-500">
                    ...
                    <span class="text-purple-600">Crear Enlace</span>
                </div>
            </div>
        </header>
        ...
        <main class="flex-1 p-4 sm:p-6 lg:p-8 overflow-x-hidden">
            <div class="max-w-4xl mx-auto space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                    <form action="{{ route('admin.links.store') }}" method="POST" class="p-6 sm:p-8 space-y-6">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            {{-- Icono Bootstrap --}}
                            <div class="md:col-span-2 space-y-3" x-data="{ selectedIcon: '{{ old('icon', 'bi-box-arrow-up-right') }}' }">
                        ...
                        <div class="pt-6 border-t border-gray-200 flex items-center justify-end gap-3">
                            ...
                            <button type="submit" 
                                ...
                                <i class="bi bi-save"></i> Guardar Enlace
                            </button>
                        </div>
