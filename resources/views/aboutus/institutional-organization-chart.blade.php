...
@section('content')
    ...
    <section
        class="relative bg-slate-900 text-white py-16 lg:py-20 overflow-hidden border-b border-slate-800">
        <div class="h-1.5 w-full bg-blue-700 absolute top-0 left-0"></div>

        <div class="container mx-auto px-6 relative z-10 text-center max-w-4xl">
            <span
                class="inline-flex items-center gap-2 bg-slate-800 text-sky-400 text-xs sm:text-sm font-bold px-4 py-2 rounded-full uppercase tracking-widest mb-6 border border-slate-700">
    ...
    {{-- ===== CTA SECTION ===== --}}
    <section
        class="py-16 bg-slate-900 text-white text-center relative overflow-hidden border-t border-slate-800">
