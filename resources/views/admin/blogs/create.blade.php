@extends('layouts.app')
@section('title', 'Nueva Publicación de Blog - Panel Administrativo')
            ...
            <div class="px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <h1 class="text-xl sm:text-2xl font-extrabold text-gray-800 tracking-tight flex items-center gap-2">
                        <i class="bi bi-newspaper text-purple-600"></i> Nueva Publicación de Blog
                    </h1>
                </div>
                ...
                <div class="hidden sm:flex items-center text-sm font-medium text-gray-500">
                    ...
                    <span class="text-purple-600">Crear Entrada</span>
                </div>
            </div>
        </header>
        ...
        <main class="flex-1 p-4 sm:p-6 lg:p-8 overflow-x-hidden">
            <div class="max-w-4xl mx-auto space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                    <form action="{{ route('admin.blogs.store') }}" method="POST" enctype="multipart/form-data" class="p-6 sm:p-8 space-y-6">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2" x-data="{ imagePreview: null }">
                                <label for="image" class="block text-xs font-bold uppercase tracking-wider text-gray-700 mb-2">
                                    Imagen Principal / Portada (Opcional)
                                </label>
                                ...
                                <div class="flex flex-col sm:flex-row items-center gap-4">
                                    ...
                                    <div class="w-full flex-1">
                                        ...
                                        <p class="text-[11px] text-gray-500 mt-1.5">Formatos permitidos: JPG, PNG, WEBP, GIF. Tamaño máximo: 4 MB.</p>
                                        @error('image')
                                            <p class="text-xs text-rose-600 mt-1 font-medium">{{ $message }}</p>
                                        @enderror
                                    </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="details" id="details" rows="3" 
                                    ...
                                    class="w-full text-sm p-4 border @error('details') border-rose-500 @else border-gray-300 @enderror rounded-xl focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all">{{ old('details') }}</textarea>
                                @error('details')
                                    <p class="text-xs text-rose-600 mt-1 font-medium">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="md:col-span-2">
                                <label class="inline-flex items-center gap-3 cursor-pointer">
                                    ...
                                    <div>
                                        <span class="text-sm font-bold text-gray-800">Publicar de Forma Inmediata</span>
                                        <p class="text-xs text-gray-500">Si está marcado, la noticia estará visible públicamente de inmediato en el portal web.</p>
                                    </div>
                                </label>
                            </div>
                        ...
                        <div class="pt-6 border-t border-gray-200 flex items-center justify-end gap-3">
                            ...
                            <button type="submit" 
                                ...
                                <i class="bi bi-save"></i> Guardar Publicación
                            </button>
                        </div>
