@extends('layouts.app')
@section('title', 'Nueva Diapositiva del Carrusel - Panel Administrativo')
...
<div id="dashboard-container" class="flex w-full bg-gray-50 font-sans text-gray-900 min-h-[calc(100vh-64px)]" x-data="dashboardApp()">
    ...
    <div class="flex-1 flex flex-col min-w-0 bg-gray-50/50 relative" x-data="carouselCreateApp()">
        {{-- Header --}}
            ...
            <div class="px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <h1 class="text-xl sm:text-2xl font-extrabold text-gray-800 tracking-tight flex items-center gap-2">
                        <i class="bi bi-plus-circle-fill text-purple-600"></i> Nueva Diapositiva
                    </h1>
                </div>
                ...
                <div class="hidden sm:flex items-center text-sm font-medium text-gray-500">
                    ...
                    <i class="bi bi-chevron-right mx-2 text-xs text-gray-400"></i>
                    <span class="text-purple-600 font-semibold">Crear</span>
                </div>
            </div>
        </header>
            ...
            <div class="max-w-6xl mx-auto space-y-6">
                ...
                <div class="bg-slate-950 rounded-3xl shadow-xl border border-slate-800 overflow-hidden relative select-none">
                    <div class="px-5 py-3 bg-slate-900/90 border-b border-slate-800 flex items-center justify-between text-xs text-slate-400">
                        ...
                        <span class="text-[11px] text-slate-500">Así se verá en la página de inicio</span>
                    </div>
                    ...
                    <div class="relative min-h-[280px] sm:min-h-[320px] p-6 sm:p-10 flex flex-col justify-center overflow-hidden">
                        ...
                        <div class="absolute inset-0 bg-cover bg-center transition-all duration-500"
                             :style="'background-image: url(' + (imagePreview || '{{ asset('images/slider_admision.jpg') }}') + ')'">
                        </div>
                ...
                <form action="{{ route('admin.carousel.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="bg-white rounded-3xl shadow-sm border border-gray-200 p-6 sm:p-8 space-y-6">
                        <div class="border-b border-gray-100 pb-4">
                            ...
                            <p class="text-xs text-gray-500 mt-0.5">Define los textos, títulos y colores que resaltarán en la portada.</p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div class="space-y-1.5">
                                ...
                                <div class="relative">
                                    <input type="text" id="tag_icon" name="tag_icon" x-model="tag_icon"
                                        ...
                                        value="{{ old('tag_icon', 'bi-mortarboard-fill') }}"
                            ...
                            <div class="space-y-1.5 md:col-span-2">
                                ...
                                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
                                    @php
                                        $colorOptions = [
                                            ['value' => 'amber',   'label' => 'Amber / Oro',     'bg' => 'bg-amber-500',   'border' => 'border-amber-400'],
                                            ['value' => 'sky',     'label' => 'Sky / Celeste',   'bg' => 'bg-sky-500',     'border' => 'border-sky-400'],
                                            ['value' => 'rose',    'label' => 'Rose / Rosa',     'bg' => 'bg-rose-500',    'border' => 'border-rose-400'],
                                            ['value' => 'emerald', 'label' => 'Emerald / Verde', 'bg' => 'bg-emerald-500', 'border' => 'border-emerald-400'],
                                            ['value' => 'indigo',  'label' => 'Indigo / Azul',   'bg' => 'bg-indigo-500',  'border' => 'border-indigo-400'],
                                            ['value' => 'purple',  'label' => 'Purple / Violeta','bg' => 'bg-purple-500',  'border' => 'border-purple-400'],
                                        ];
                                    @endphp
                            ...
                            <div class="space-y-1.5 md:col-span-2">
                                ...
                                <textarea id="description" name="description" x-model="description" rows="3"
                                    ...
                                    class="w-full text-sm border border-gray-300 rounded-xl py-2.5 px-3.5 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all">{{ old('description') }}</textarea>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="p-5 rounded-2xl bg-gray-50 border border-gray-200/80 space-y-4">
                                ...
                                <div class="space-y-1.5">
                                    ...
                                    <input type="text" id="primary_button_text" name="primary_button_text" x-model="primary_button_text"
                                        placeholder="Ej: Examen de Admisión" value="{{ old('primary_button_text') }}"
                                ...
                                <div class="space-y-1.5">
                                    ...
                                    <input type="text" id="primary_button_url" name="primary_button_url"
                                        placeholder="Ej: examen-de-admision o /admision" value="{{ old('primary_button_url') }}"
                                ...
                                <div class="space-y-1.5">
                                    ...
                                    <input type="text" id="primary_button_icon" name="primary_button_icon" x-model="primary_button_icon"
                                        placeholder="Ej: bi-pencil-square" value="{{ old('primary_button_icon', 'bi-pencil-square') }}"
                                        class="w-full text-sm border border-gray-300 rounded-xl py-2 px-3 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all bg-white">
                                </div>
                            </div>
                            ...
                            <div class="p-5 rounded-2xl bg-gray-50 border border-gray-200/80 space-y-4">
                                ...
                                <div class="space-y-1.5">
                                    ...
                                    <input type="text" id="secondary_button_text" name="secondary_button_text" x-model="secondary_button_text"
                                        placeholder="Ej: Ver 5 Carreras" value="{{ old('secondary_button_text') }}"
                                        class="w-full text-sm border border-gray-300 rounded-xl py-2 px-3 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all bg-white font-medium">
                                </div>
                                ...
                                <div class="space-y-1.5">
                                    ...
                                    <input type="text" id="secondary_button_url" name="secondary_button_url"
                                        placeholder="Ej: programas-de-estudio o /nosotros" value="{{ old('secondary_button_url') }}"
                                        class="w-full text-sm border border-gray-300 rounded-xl py-2 px-3 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all bg-white">
                                </div>
                                ...
                                <div class="space-y-1.5">
                                    ...
                                    <input type="text" id="secondary_button_icon" name="secondary_button_icon" x-model="secondary_button_icon"
                                        placeholder="Ej: bi-grid-3x3-gap-fill" value="{{ old('secondary_button_icon', 'bi-grid-3x3-gap-fill') }}"
                                        class="w-full text-sm border border-gray-300 rounded-xl py-2 px-3 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all bg-white">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-3xl shadow-sm border border-gray-200 p-6 sm:p-8 space-y-6">
                        <div class="border-b border-gray-100 pb-4">
                            ...
                            <p class="text-xs text-gray-500 mt-0.5">Sube una foto de alta calidad (1920x800 px recomendado, JPG, PNG o WEBP).</p>
                        </div>
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="border-2 border-dashed border-gray-300 hover:border-purple-500 rounded-2xl p-5 text-center transition-colors bg-gray-50/50 relative">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <p class="text-xs font-bold text-gray-700">Arrastra una imagen o haz clic aquí</p>
                                        <p class="text-[11px] text-gray-400">Recomendado: 1920x800 píxeles. Máx: 5MB (JPG, WEBP, PNG)</p>
                                    </div>
                                </div>
                            </div>
...
@push('scripts')
<script>
    function carouselCreateApp() {
        return {
            title: '{{ old('title', 'Tu futuro profesional empieza aquí, en el') }}',
            highlight_text: '{{ old('highlight_text', 'IESTP Francisco Vigo Caballero') }}',
            tag: '{{ old('tag', 'Admisión 2026-I • Modalidades Abiertas') }}',
            tag_icon: '{{ old('tag_icon', 'bi-mortarboard-fill') }}',
            tag_color: '{{ old('tag_color', 'amber') }}',
            description: '{{ old('description', 'Estudia una de nuestras 5 carreras técnicas a Nombre de la Nación en Uchiza. Formación con alta demanda laboral, plana docente calificada y modernos ambientes.') }}',
            primary_button_text: '{{ old('primary_button_text', 'Examen de Admisión') }}',
            primary_button_icon: '{{ old('primary_button_icon', 'bi-pencil-square') }}',
            secondary_button_text: '{{ old('secondary_button_text', 'Ver 5 Carreras') }}',
            secondary_button_icon: '{{ old('secondary_button_icon', 'bi-grid-3x3-gap-fill') }}',
            imagePreview: null,
