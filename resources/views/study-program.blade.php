        ...
        <div class="container mx-auto px-6 relative z-10">
            <div class="flex flex-col lg:flex-row items-center gap-12">
                ...
                <div class="lg:w-7/12 text-left">
                    <span
                        class="inline-flex items-center gap-1.5 bg-{{ $meta['color'] }}-500/25 text-{{ $meta['color'] }}-200 text-xs font-bold px-4 py-2 rounded-full uppercase tracking-widest mb-6 border border-{{ $meta['color'] }}-500/40">
                ...
                <div class="lg:w-5/12 w-full">
                    <div class="relative rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
                        ...
                        @else
                            <div
                                class="w-full h-80 lg:h-96 bg-gradient-to-br {{ $meta['gradient'] }} flex items-center justify-center">
        ...
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div class="lg:col-span-2 space-y-12">
                    ...
                    <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            @foreach ($meta['competencias'] as $item)
                                <div
                                    class="flex gap-4 p-5 rounded-2xl bg-gray-50 border border-gray-100 hover:border-{{ $meta['color'] }}-200 transition-colors">
                                    <div
                                        class="w-12 h-12 rounded-xl bg-{{ $meta['color'] }}-100 text-{{ $meta['color'] }}-600 flex items-center justify-center shrink-0">
                            ...
                            <div class="space-y-6">
                                @foreach ($program->modules as $index => $module)
                                    <div class="timeline-item flex gap-6 relative">
                                        {{-- Bullet decoration --}}
                                        <div
                                            class="timeline-bullet w-10 h-10 rounded-full bg-{{ $meta['color'] }}-500 text-white font-extrabold flex items-center justify-center shrink-0 relative z-10 shadow-sm">
                                            {{ $index + 1 }}
                                        </div>
                                        ...
                                        <div class="flex-grow bg-gray-50 border border-gray-100 rounded-2xl p-6 relative">
                                            <div class="flex flex-wrap items-center justify-between gap-4 mb-3">
                                                <span
                                                    class="px-3 py-1 text-[11px] font-bold uppercase tracking-wider rounded-full bg-{{ $meta['color'] }}-100 text-{{ $meta['color'] }}-800">
                                            ...
                                            <p class="text-xs text-gray-600 leading-relaxed">
                                                Certificación otorgada al concluir satisfactoriamente las asignaturas y las
                                                horas de experiencias formativas correspondientes a este módulo.
                                            </p>
                                        </div>
                                    </div>
                                @endforeach
                    ...
                    @if ($albumImages->isNotEmpty())
                        <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm" x-data="{
                            ...
                            <p class="text-gray-500 mb-8 text-sm">
                                Conoce nuestras aulas, laboratorios, parcelas de producción o actividades prácticas que
                                realizan nuestros estudiantes en Uchiza.
                            </p>
                                        ...
                                        <div class="flex items-center justify-center gap-2 mt-4 flex-wrap">
                                            <template x-for="(img, idx) in images" :key="idx">
                                                <button @click="activeIndex = idx"
                                                    ...
                                                    :class="activeIndex === idx ? 'bg-{{ $meta['color'] }}-500 scale-125' :
                ...
                <div class="space-y-8">
                    ...
                    <div class="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm glow-effect">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start gap-3.5">
                                ...
                                <div>
                                    <p class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Título Oficial
                                    </p>
                            ...
                            <div class="flex items-start gap-3.5">
                                ...
                                <div>
                                    <p class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Duración de
                                        Estudios</p>
                                    <p class="text-xs text-gray-700 font-semibold mt-0.5">3 Años (6 semestres académicos)
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3.5">
                                ...
                                <div>
                                    <p class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Horario de
                                        Clases</p>
                                    <p class="text-xs text-gray-700 font-semibold mt-0.5">Lunes a Viernes 7:30 am – 1:30 pm
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3.5">
                                ...
                                <div>
                                    <p class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Matrícula y
                                        Pensión</p>
                                    <p class="text-xs text-gray-700 font-semibold mt-0.5">Costo Social Anual (Sin
                                        mensualidades)</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <ul class="space-y-3">
                            @foreach ($meta['campo_laboral'] as $item)
                                <li class="text-xs text-gray-700 flex items-start gap-2.5 leading-relaxed">
                                    <i
                                        class="bi bi-check2-circle text-{{ $meta['color'] }}-500 shrink-0 mt-0.5 text-sm"></i>
                                    <span>{{ $item }}</span>
                                </li>
                            @endforeach
                        </ul>
                    ...
                    {{-- CTA Box --}}
                    <div
                        class="bg-gradient-to-br {{ $meta['gradient'] }} rounded-3xl p-6 text-white text-center shadow-lg relative overflow-hidden">
                        <div
                        ...
                        <div class="relative z-10">
                            ...
                            <p class="text-xs text-white/80 leading-relaxed mb-6">
                                El examen de admisión está cerca. Asegura tu futuro profesional técnico sin pagar
                                mensualidades.
                            </p>
