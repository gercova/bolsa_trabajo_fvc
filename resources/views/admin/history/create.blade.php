@extends('layouts.app')
@section('title', 'Nuevo Hito Histórico - Panel Administrativo')
            ...
            <div class="px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <h1 class="text-xl sm:text-2xl font-extrabold text-gray-800 tracking-tight flex items-center gap-2">
                        <i class="bi bi-plus-circle-fill text-purple-600"></i> Registrar Hito Histórico
                    </h1>
                </div>
        ...
        <main class="flex-1 p-4 sm:p-6 lg:p-8 overflow-x-hidden">
            <div class="max-w-4xl mx-auto">
                ...
                <form action="{{ route('admin.history.store') }}" method="POST" enctype="multipart/form-data" 
                      x-data="historyForm()" class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                    @csrf
                    ...
                    <div class="p-6 sm:p-8 space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="start_year" id="start_year" value="{{ old('start_year') }}" min="1900" max="2100"
                                           placeholder="Ej: 1991"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="end_year" id="end_year" value="{{ old('end_year') }}" min="1900" max="2100"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="order" id="order" value="{{ old('order', $nextOrder) }}" min="0" max="255"
                                           class="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all">
                                ...
                                <div class="flex-1 w-full">
                                    <div class="border-2 border-dashed border-gray-300 hover:border-purple-500 rounded-2xl p-6 text-center transition-colors cursor-pointer bg-gray-50/50 relative group"
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <p class="text-sm font-bold text-gray-700">Haz clic para subir o arrastra una imagen</p>
                                            <p class="text-xs text-gray-500">Recomendado: 1200x800 px o superior</p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="w-40 h-28 rounded-xl border border-gray-200 bg-gray-100 overflow-hidden flex items-center justify-center relative shadow-sm">
                                        <template x-if="imageUrl">
                                            <div class="relative w-full h-full group">
                                                ...
                                                <button type="button" @click="clearImage()" class="absolute top-1 right-1 bg-red-600 text-white rounded-full w-6 h-6 flex items-center justify-center shadow hover:bg-red-700">
                                        ...
                                        <template x-if="!imageUrl">
                                            <div class="text-center text-gray-400 p-2">
                                                ...
                                                <p class="text-[10px] mt-1">Sin imagen seleccionada</p>
                                            </div>
                                        </template>
                                    </div>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="8" required
                                      ...
                                      class="w-full px-4 py-3 text-sm border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all font-sans leading-relaxed">{{ old('description') }}</textarea>
                        ...
                        <div class="pt-2">
                            <label class="relative inline-flex items-center cursor-pointer">
                                ...
                                <span class="ml-3 text-sm font-bold text-gray-800">Publicar hito inmediatamente (Estado Activo)</span>
                            </label>
                        </div>
                    ...
                    <div class="p-6 bg-gray-50 border-t border-gray-200 flex flex-col sm:flex-row justify-end items-center gap-3">
                        ...
                        <button type="submit" class="w-full sm:w-auto px-6 py-2.5 text-sm font-bold text-white bg-gradient-to-r from-purple-600 to-indigo-600 rounded-xl hover:from-purple-700 hover:to-indigo-700 transition shadow-md shadow-purple-500/20 flex items-center justify-center gap-2">
                            ...
                            <span>Guardar Hito Histórico</span>
                        </button>
                    </div>
                </form>
            </div>
