@extends('layouts.app')
@section('title', 'Crear Examen - Panel Administrativo')
@section('content')
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                ...
                                <div class="lg:col-span-1 space-y-6">
                                    <div class="bg-gray-50 rounded-xl p-6 border border-gray-200 shadow-sm">
                                        ...
                                        {{-- PDF Upload (Bases) --}}
                                        <div class="mb-6">
                                            <label for="url_pdf" class="block mb-2 text-xs font-bold text-gray-700 uppercase tracking-wider">
                                        ...
                                        <div class="mb-6 border-t border-gray-200 pt-4">
                                            <label for="results_url_pdf" class="block mb-2 text-xs font-bold text-gray-700 uppercase tracking-wider">
                                            ...
                                            <p class="text-[10px] text-gray-500 mt-2">
                                                <i class="bi bi-info-circle"></i>
                                                Opcional. Cuadro de méritos / lista de ingresantes (PDF).
                                            </p>
                                        ...
                                        <div class="border-t border-gray-200 pt-4">
                                            ...
                                            <p class="text-[10px] text-gray-500 mt-2 ml-8">Los exámenes inactivos no se listarán en la página pública para los postulantes.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="lg:col-span-2">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        {{-- Periodo --}}
                                        <div>
                                            <label for="period" class="block mb-2 text-xs font-bold text-gray-700 uppercase tracking-wider">
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="text" name="period" id="period" value="{{ old('period') }}"
                                                    placeholder="Ej: 2027-I" required
                                        ...
                                        {{-- Total Vacantes --}}
                                        <div>
                                            <label for="total_vacancies" class="block mb-2 text-xs font-bold text-gray-700 uppercase tracking-wider">
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="number" name="total_vacancies" id="total_vacancies" value="{{ old('total_vacancies', 0) }}"
                                                    placeholder="Ej: 150" min="0" required
                                        ...
                                        <div>
                                            <label for="price" class="block mb-2 text-xs font-bold text-gray-700 uppercase tracking-wider">
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="number" step="0.01" name="price" id="price" value="{{ old('price', 0.00) }}"
                                                    placeholder="Ej: 150.00" min="0" required
                                        ...
                                        <div>
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="number" step="0.01" name="tuition_fee" id="tuition_fee" value="{{ old('tuition_fee', 0.00) }}"
                                                    placeholder="Ej: 80.00" min="0"
                                        ...
                                        <div>
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="number" step="0.01" name="monthly_fee" id="monthly_fee" value="{{ old('monthly_fee', 0.00) }}"
                                                    placeholder="Ej: 100.00" min="0"
                                        ...
                                        {{-- Tipo --}}
                                        <div>
                                            <label for="type" class="block mb-2 text-xs font-bold text-gray-700 uppercase tracking-wider">
                                            ...
                                            <div class="relative">
                                                ...
                                                <select name="type" id="type" required
                                                    ...
                                                    <option value="ordinario" {{ old('type') == 'ordinario' ? 'selected' : '' }}>Ordinario</option>
                                                    <option value="extraordinario" {{ old('type') == 'extraordinario' ? 'selected' : '' }}>Extraordinario</option>
                                                </select>
                                        ...
                                        {{-- Fecha Examen --}}
                                        <div>
                                            <label for="exam_date" class="block mb-2 text-xs font-bold text-gray-700 uppercase tracking-wider">
                                        ...
                                        <div>
                                            <label for="inscription_start_date" class="block mb-2 text-xs font-bold text-gray-700 uppercase tracking-wider">
                                                <i class="bi bi-calendar-check text-purple-600 mr-1"></i>
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="date" name="inscription_start_date" id="inscription_start_date" value="{{ old('inscription_start_date') }}" required
                                        ...
                                        <div>
                                            <label for="inscription_end_date" class="block mb-2 text-xs font-bold text-gray-700 uppercase tracking-wider">
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="date" name="inscription_end_date" id="inscription_end_date" value="{{ old('inscription_end_date') }}" required
                                                    class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition text-sm @error('inscription_end_date') border-red-500 @enderror">
                                            </div>
                                        ...
                                        <div class="md:col-span-2">
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="text" name="activity" id="activity" value="{{ old('activity') }}" placeholder="Ej: Matrícula Regular 2026-I, Ciclo Preparatorio CEPRE 2027-I..." required
                                        ...
                                        <div class="md:col-span-2">
                                            ...
                                            <textarea name="indications" id="indications" rows="4"
                                                ...
                                                class="w-full p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition text-sm @error('indications') border-red-500 @enderror">{{ old('indications') }}</textarea>
                                        ...
                                        <div class="md:col-span-2 mt-6">
                                            <h3 class="text-sm font-bold text-gray-800 mb-4 border-b pb-2 flex items-center gap-2 uppercase tracking-wider">
                                                <i class="bi bi-book text-purple-600"></i>
                                                Vacantes por Programa de Estudio
                                            </h3>
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                @foreach($programs as $index => $program)
                                                    <div class="bg-gray-50 p-4 rounded-xl border border-gray-200 flex items-center justify-between shadow-sm">
                                                        <span class="text-xs font-semibold text-gray-700">{{ $program->name }}</span>
                                                        <div class="w-32">
                                                            <input type="hidden" name="programs[{{ $index }}][program_id]" value="{{ $program->id }}">
                                                            <input type="number" name="programs[{{ $index }}][vacancies]" min="0" 
                                                                value="{{ old("programs.{$index}.vacancies", 0) }}" 
